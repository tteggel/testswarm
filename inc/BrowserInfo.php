        ...
        public function getSwarmUaItem() {
                ...
                if ( $this->swarmUaItem === null ) {
                        ...
                        foreach ( $uaItems as $uaID => $uaItem ) {
                                if ( $uaID === "{$browscap->Platform}|{$browscap->Browser}|{$browscap->MajorVer}|{$browscap->MinorVer}" ) {
                                        $found = $uaItem;
                                        $found->id = $uaID;
                                        break;
                                } elseif ( $uaID === "{$browscap->Platform}|{$browscap->Browser}|{$browscap->MajorVer}" ) {
                                        $found = $uaItem;
                                        $found->id = $uaID;
                                        break;
                                } elseif ( $uaID === "{$browscap->Platform}|{$browscap->Browser}" ) {
                                        $found = $uaItem;
                                        $found->id = $uaID;
                                        break;
                                }
